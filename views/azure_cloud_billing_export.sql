SELECT
  ...
  FORMAT_DATE("%Y/%m/%d",PARSE_DATE("%m/%d/%Y",servicePeriodEndDate)) as servicePeriodEndDate,
  FORMAT_DATE("%Y/%m/%d",PARSE_DATE("%m/%d/%Y",servicePeriodStartDate)) as servicePeriodStartDate,
  FORMAT_DATE("%Y/%m/%d",PARSE_DATE("%m/%d/%Y",date)) as date,
  serviceFamily,
  productOrderId,
  productOrderName,
  consumedService,
  ...
  FORMAT_DATE("%Y/%m/%d",PARSE_DATE("%m/%d/%Y",exchangeRateDate)) as exchangeRateDate,
